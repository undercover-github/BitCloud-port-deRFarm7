/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsAIB.h 20838 2012-04-11 08:47:42Z mgekk $
 ******************************************************************************/
/**//**
 *
...
#define APS_IS_SET_SEC_POLICY_BIT(spid, mask) \
  ((mask) == (csAIB.securityPolicy[(spid)] & (mask)))
#define APS_CMD_MAYBE_ENCRYPTED(spid) \
  (0U < (csAIB.securityPolicy[spid] & APS_ENCRYPT_OUT_CMD))
...
/**************************************************************************//**
  ...
  \return None
 ******************************************************************************/
INLINE void APS_UpdateSecurityPolicy(const APS_SecurityPolicyId_t spid,
  const APS_SecurityPolicy_t policy)
{
  csAIB.securityPolicy[spid] = policy;
}
#endif /* _LINK_SECURITY_ */
#endif /* _SECURITY_ */
