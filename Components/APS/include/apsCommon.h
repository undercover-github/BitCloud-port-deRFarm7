/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsCommon.h 20614 2012-03-23 09:37:37Z arazinkov $
 ******************************************************************************/
 ...
 *
 *    APS status values used in most of standard primives except for
...
typedef enum
{
  ...
  /** A parameter's value is out of range. */
...
typedef struct _ApsCommandReq_t
{
  ...
  /** Callback function for confirming of APS command transmission */
...
/*************************************************************************//**
  ...
  \param regProfileId - profile Id of the registered Simple Descriptor.
  \param inProfileId - profile Id of an incoming APS packet.

  \return None
 *****************************************************************************/
bool APS_IsProfileIdMatched(const ProfileId_t regProfileId,
