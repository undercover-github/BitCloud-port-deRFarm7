/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsCryptoKeys.h 20767 2012-04-04 15:12:16Z arazinkov $
 ******************************************************************************/
...
/**************************************************************************//**
  ...
  \return None.
 ******************************************************************************/
void APS_ResetKeyPairSet(const NWK_PowerFailureControl_t powerFailureControl);
...
#define APS_ResetKeyPairSet(powerFailureControl) ((void)0)
