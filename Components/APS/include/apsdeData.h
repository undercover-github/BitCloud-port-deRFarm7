/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsdeData.h 20614 2012-03-23 09:37:37Z arazinkov $
 ******************************************************************************/
 ...
 * \li to enable indications from broadcast transmissions set indicateBroadcasts to 1
 *
 */
BEGIN_PACK
typedef struct PACK
...
::BROADCAST_ADDR_ALL to send a message to all nodes in the network, ::BROADCAST_ADDR_RX_ON_WHEN_IDLE
