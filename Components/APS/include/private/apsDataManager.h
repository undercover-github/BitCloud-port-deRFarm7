...
/*****************************************************************************
  Tries to find IEEE address by short network address

  Parameters: shortAddr - short netwirk address
  Returns: pointer to extended address if that is present,
  NULL otherwise
*****************************************************************************/
APS_PRIVATE const ExtAddr_t* apsFindExtByShort(const ShortAddr_t shortAddr);
