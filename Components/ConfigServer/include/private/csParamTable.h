...
RAM_PARAMETER(CS_UID_ID, tal_pib_IeeeAddress)
RAM_PARAMETER(CS_MAX_FRAME_TRANSMISSION_TIME_ID, maxFrameTransmissionTime)
...
RAM_PARAMETER(CS_MAX_LINK_ROUTE_COST_ID, csNIB.maxLinkRouteCost)
...
RAM_PARAMETER(CS_NWK_LEAVE_REQ_ALLOWED_ID, csNIB.leaveReqAllowed)
...
RAM_PARAMETER(CS_SHORT_TRUST_CENTER_ADDRESS_ID, csAIB.tcNwkAddr)
#endif /* _SECURITY_ */
...
FLASH_PARAMETER(CS_ZCL_BUFFER_SIZE_ID, csReadOnlyItems.csZclMemoryBuffersSize)
  #ifdef _OTAU_
...
#ifdef _ZCL_
MEMORY_REGION(CS_ZCL_BUFFERS_ID, stackBuffers.zclBuffers)
MEMORY_REGION(CS_ZCL_BUFFER_DESCRIPTORS_ID, stackBuffers.zclMmBufferDescriptors)
  #ifdef _OTAU_
...
MEMORY_REGION(CS_ZCL_OTAU_CLIENT_SESSION_MEMORY_ID, stackBuffers.csOtauSimultaneousClientSession)
    #ifdef _OTAU_PAGE_REQUEST_
MEMORY_REGION(CS_ZCL_OTAU_MISSED_BYTES_MASK_ID, stackBuffers.csOtauMissedBytesMask)
