...
// the macros for LEDs
HAL_ASSIGN_PIN(LED_0, B, AT91C_PIO_PB3);
HAL_ASSIGN_PIN(LED_1, B, AT91C_PIO_PB25);
HAL_ASSIGN_PIN(LED_2, B, AT91C_PIO_PB2);
HAL_ASSIGN_PIN(LED_3, B, AT91C_PIO_PB0);
HAL_ASSIGN_PIN(LED_4, B, AT91C_PIO_PB8);
HAL_ASSIGN_PIN(LED_5, B, AT91C_PIO_PB6);
HAL_ASSIGN_PIN(LED_6, B, AT91C_PIO_PB18);
HAL_ASSIGN_PIN(LED_7, B, AT91C_PIO_PB15);

// the macros for first led
HAL_ASSIGN_PIN(FIRST_HON, B, AT91C_PIO_PB3);
