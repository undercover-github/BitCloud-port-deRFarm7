...
typedef enum _ZdoModuleSet_t
{
  ...
  ZDO_IN_NETWORK_MODULE_SET     = ZDO_BINDING_MANAGER_MODULE_ID | ZDO_DISCOVERY_MANAGER_MODULE_ID |
                                  ...
                                  ZDO_LEAVE_NETWORK_MODULE_ID | ZDO_TC_SWAPOUT_MODULE_ID | ZDO_RANDOM_MODULE_ID,
...
/******************************************************************************
                    Prototypes section
******************************************************************************/
ZDO_PRIVATE void zdoUpdateRandSeed(void);
...
/******************************************************************************
  ...
  Return:
    none
******************************************************************************/
static inline void zdoSetOutOfNetworkFlag(void)
{
