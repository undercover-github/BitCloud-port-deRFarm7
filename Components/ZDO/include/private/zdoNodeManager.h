...
ZDO_PRIVATE void zdoZdpNodeManagerReset(void);
ZDO_PRIVATE void zdoExecuteEDScan(uint32_t scanChannels, uint8_t scanDuration);
ZDO_PRIVATE void zdoZdpNodeRequestCreate(void);
ZDO_PRIVATE void zdoZdpNodeMessageInd(void);
...
/******************************************************************************
 ...
 Returns:
   None.
******************************************************************************/
ZDO_PRIVATE void zdoSetChannelChangeTimer(const uint32_t scanChannels);
